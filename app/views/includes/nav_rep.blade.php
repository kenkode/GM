                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav">
                            ...
                            <li><a href="{{ URL::to('reports/compliance/selectEmployee') }}" ><i class="fa fa-file fa-fw"></i>Employee Compliance report </a></li>
                            <li><a href="{{ URL::to('reports/promotion/selectEmployee') }}" ><i class="fa fa-file fa-fw"></i>Employee Promotion report </a></li>
