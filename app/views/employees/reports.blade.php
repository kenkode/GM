...
<div class="row">
    ...
    <ul>
      ...
      <li>
        ...
        <li>
            <a href="{{ URL::to('reports/compliance/selectEmployee') }}" >Employee Compliance report </a>
        </li>

        <li>
            <a href="{{ URL::to('reports/promotion/selectEmployee') }}" >Employee Promotion report </a>
        </li>
