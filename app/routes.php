...
Route::get('leaverosters', 'LeaveapplicationsController@roster');

Route::post('leaverosters/create', 'LeaveapplicationsController@rostercreate');
Route::post('leaverosters/view', 'LeaveapplicationsController@rosterview');
...
Route::get('leaveReports/selectRosterPeriod', 'ReportsController@rosterperiod');
Route::post('leaveReports/leaverosters', 'ReportsController@leaverosters');
...
Route::get('css/leaveroster', function(){
  ...
  $employee = Employee::findorfail($employeeid);
   ...
   $leaveapplications = DB::table('leaveapplications')->where('organization_id',Confide::user()->organization_id)->where('employee_id', '=', $employee->id)->whereYear('application_date', '=', date('Y'))->get();

  return View::make('css.leaveroster', compact('employee', 'leaveapplications'));
});
...
Route::get('css/leaveroster/application', function(){
  ...
  return View::make('css.leaverosterapplication', compact('employee', 'leavetypes'));
});
