  ...
  <div class="col-lg-5">
    ...
    <fieldset>
       ...
       <div class="col-lg-4">
                  <div class="checkbox">
                        <label>
                            <input type="checkbox" name="weekends" id="weekends" value="$leaveapplication->is_weekend"<?= ($leaveapplication->is_weekend=='1')?'checked="checked"':''; ?>>
                                Include Weekends
                        </label>
                    </div>
                 </div>
        ...
        <div class="col-lg-4">
                  <div class="checkbox">
                        <label>
                            <input type="checkbox" name="holidays" id="holidays" value="$leaveapplication->is_holiday"<?= ($leaveapplication->is_holiday=='1')?'checked="checked"':''; ?>>
                                Include Holidays
                        </label>
                    </div>
                 </div>
       ...
       <div class="form-group col-lg-12">
                        ...
                        <input required class="form-control days"  placeholder="" type="text" name="days" id="days" value="{{Leaveapplication::getDays($leaveapplication->applied_end_date,$leaveapplication->applied_start_date,$leaveapplication->is_weekend,$leaveapplication->is_holiday)+1}}">
