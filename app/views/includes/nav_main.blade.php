 <nav class="navbar-default navbar-static-side" id="wrap" role="navigation">
            ...
            <div class="sidebar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="{{ URL::to('compliance')}}"><i class="fa fa-user fa-fw"></i>Compliance</a>
                    </li>

                    <li>
                        <a href="{{ URL::to('promotions')}}"><i class="fa fa-user fa-fw"></i>Promotions/ Demotions</a>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav">
                            ...
                            <li><a href="{{ URL::to('reports/compliance/selectEmployee') }}">Employee Compliance report </a></li>

                            <li><a href="{{ URL::to('reports/promotion/selectEmployee') }}" >Employee Promotion report </a></li>
